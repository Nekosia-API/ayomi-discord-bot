...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('heterochromia')
		.setDescription('Get an image of characters with heterochromia (different-colored eyes).')
	...
	execute: (_, inter) => fetchImage(inter, 'heterochromia')
};