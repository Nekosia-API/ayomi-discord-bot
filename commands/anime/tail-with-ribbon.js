...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('tail-with-ribbon')
		.setDescription('Get a charming image of an animal tail adorned with a cute ribbon!')
	...
	execute: (_, inter) => fetchImage(inter, 'tail-with-ribbon'),
};